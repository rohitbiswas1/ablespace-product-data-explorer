...
var ProductController = function () {
    ...
    var ProductController = _classThis = /** @class */ (function () {
        ...
        ProductController_1.prototype.findAll = function (categoryId, page, limit) {
            var catId = categoryId ? parseInt(categoryId) : undefined;
            return this.productService.findAll(catId, page, limit);
        };
