...
var CategoryService = function () {
    ...
    var CategoryService = _classThis = /** @class */ (function () {
        function CategoryService_1(prisma) {
            this.prisma = prisma;
        }
        CategoryService_1.prototype.findAll = function (navigationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (navigationId) {
                        return [2 /*return*/, this.prisma.category.findMany({ where: { navigationId: navigationId } })];
                    }
