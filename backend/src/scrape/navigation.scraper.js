...
var NavigationScraper = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var NavigationScraper = _classThis = /** @class */ (function () {
        function NavigationScraper_1() {
            this.logger = new common_1.Logger(NavigationScraper.name);
        }
        NavigationScraper_1.prototype.scrape = function (context) {
