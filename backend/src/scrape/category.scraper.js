...
var CategoryScraper = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var CategoryScraper = _classThis = /** @class */ (function () {
        function CategoryScraper_1() {
            this.logger = new common_1.Logger(CategoryScraper.name);
        }
        CategoryScraper_1.prototype.scrape = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var log;
                return __generator(this, function (_a) {
                    log = context.log;
                    log.info('Scraping Category...');
                    return [2 /*return*/];
                });
            });
        };
        return CategoryScraper_1;
    }());
